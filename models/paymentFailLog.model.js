 ...
 *     , json_response     JSON                     COMMENT 'This value is not documented' 
 * ) COMMENT '전달받은 EasyPay 문서의 신뢰성이 떨어져서 ENUM을 사용하기 어려워 보임';
 */
('use strict');
const { Model } = require('sequelize');
module.exports = (sequelize, DataTypes) => {
  class PaymentFailLog extends Model {
    static associate(models) {
      models.PaymentFailLog.belongsTo(models.sb_charging_log, {
        as: 'chargingLogs',
        foreignKey: 'cno',
        targetKey: 'pg_cno',
        constraints: false,
      });
      models.PaymentFailLog.belongsTo(models.sb_charger, {
        as: 'sb_charger_memb',
        foreignKey: 'chg_id',
        targetKey: 'chg_id',
        constraints: false,
      });
      models.PaymentFailLog.hasMany(models.RequestRefund, {
        as: 'requestRefunds',
