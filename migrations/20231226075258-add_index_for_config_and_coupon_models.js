...
const FIRST_MODEL_NAME = 'Configs';
const FIRST_COLUMN_NAME = ['divComment'];

const SECOND_MODEL_NAME = 'CouponModels';
const SECOND_COLUMN_NAME = ['number', 'createdWho', 'updatedWho'];
