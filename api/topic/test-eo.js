...
function service(_request, _response, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const testNotification = yield notification.operationErrorSend('EO', 'test@testemailonly.com', // 테스트를 위한 발신용 이메일
            '이메일 전송 기능 개발을 위한 테스트입니다.', '안녕하세요. 이메일 테스트입니다.', '01012345678', 'TEMPLATE');
